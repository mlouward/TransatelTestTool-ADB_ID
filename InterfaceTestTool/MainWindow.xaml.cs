    ...
    public partial class MainWindow : Window
    {
            ...
            try
            {
                using (StreamReader sr = new StreamReader(path))
                {
                    ...
                    while (!sr.EndOfStream)
                    {
                        ...
                        if (l.Length == 3) // No phone name provided
                            res.Add(new Phone(int.Parse(l[0]), l[1], l[2]));
                        else if (l.Length > 3) // Phone name provided
                            res.Add(new Phone(int.Parse(l[0]), l[1], l[2], l[3]));
                    }
                }
            }
            catch (Exception ex)
        ...
        private void UpdatePhoneList()
        {
            ...
            try
            {
                ...
                // rootList.txt is generated by checkRoot.py
