...
adb -s %1 shell svc data disable & adb -s %1 shell "su -c 'settings put global multi_sim_data_call %5 && am broadcast -a android.intent.action.SUB_DEFAULT_CHANGED'" & timeout 1 > nul
